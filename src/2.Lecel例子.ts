...
//                                 ▼
// ┌─────────────────────────────────────────────────────────────────┐
// │                    RunnableParallel（并行分发）                   │
// │                                                                 │
// │   ┌──────────────────┬──────────────────┬──────────┬────────┐  │
// │   ▼                  ▼                  ▼          ▼        │  │
// │ english           japanese          analysis   original     │
// │   │                  │                  │          │        │  │
// │   ▼                  ▼                  ▼          ▼        │  │
// │ ┌─────────┐      ┌─────────┐      ┌─────────┐  ┌────────┐   │  │
// │ │assign   │      │assign   │      │analysis │  │Lambda  │   │  │
// │ │language │      │language │      │ Chain   │  │.text   │   │  │
// │ │="English"│      │="Japanese"│     │         │  │        │   │  │
// │ └────┬────┘      └────┬────┘      └────┬────┘  └───┬────┘   │  │
// │      ▼                ▼                 ▼           ▼        │  │
// │ ┌─────────────────────────────────────────────────────────┐  │  │
// │ │              translateChain (翻译链) × 2                 │  │  │
// │ │  ┌──────────┐    ┌──────────┐    ┌──────────────────┐  │  │  │
// │ │  │ Prompt   │ -> │  Model   │ -> │ StringOutputParser│  │  │  │
// │ │  │ Template │    │ (LLM)    │    │ (取 .content)    │  │  │  │
// │ │  └──────────┘    └──────────┘    └──────────────────┘  │  │  │
// │ └─────────────────────────────────────────────────────────┘  │  │
// │                                                         │  │  │
// │ ┌─────────────────────────────────────────────────────────┐  │  │
...
// │                                                                 │
// │  {                                                              │
// │    english: "Large Language Models capture long-range...",     │
// │    japanese: "大言語モデルは...長距離依存関係を...",            │
// │    analysis: { topics: ["AI", "NLP"], difficulty: "hard" },    │
// │    original: "大语言模型通过自注意力机制捕获序列中的长距离依赖关系"│
// │  }                                                              │
// └───────────────────────────────┬─────────────────────────────────┘
//                                 │
//                                 ▼
...
// │  """                                                            │
// │  原文: 大语言模型通过自注意力机制捕获序列中的长距离依赖关系       │
// │  英文: Large Language Models capture long-range dependencies... │
// │  日文: 大言語モデルは...                                        │
// │  主题: AI, NLP                                                  │
// │  难度: hard                                                     │
// │  """                                                            │
